...
<body>
    <header class="header">
        <ul>
            ...
            <li><a href="#"></a></li>
            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" ><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg></a></li>
        </ul>
    </header>
    <section class="conteiner">
        <div class="configure">
            <h1 class="titulo">Jogo</h1>
        </div>
        <div class="principal active">
            <button id="iniciar_jogo" type="button">Iniciar</button>
            <button id="mostrar_personagens" type="button"><a href="personagens.php">Escolha seu Avatar</a></button>
